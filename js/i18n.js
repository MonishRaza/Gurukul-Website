...
var SITE_I18N = {
  hi: {
    ...
    "privacy.intro": "यह गोपनीयता नीति बताती है कि <strong>गुरुकुल अकादमी उच्चतर माध्यमिक विद्यालय, अमरपाटन</strong> (\"विद्यालय\", \"हम\") <strong>गुरुकुल-टीम (अमरपाटन)</strong> वेब व मोबाइल ऐप (इसके बाद \"ऐप\") का उपयोग करते समय जानकारी कैसे एकत्र, उपयोग और सुरक्षित करता है। ऐप केवल स्टाफ के लिए एक कार्यबल प्रबंधन उपकरण है — यह कोई सार्वजनिक सामाजिक उत्पाद नहीं है। अभिभावक और विद्यार्थी ऐप में लॉगिन नहीं करते।",
    ...
    "staffapp.metaDesc": "गुरुकुल अकादमी के स्टाफ के लिए गुरुकुल-टीम ऐप को Android फ़ोन पर Chrome से इंस्टॉल करने की चरण-दर-चरण मार्गदर्शिका।",
    "staffapp.hero.est": "★ गुरुकुल अकादमी स्टाफ के लिए",
    "staffapp.hero.title": "गुरुकुल-टीम — अपने फ़ोन पर इंस्टॉल करें",
